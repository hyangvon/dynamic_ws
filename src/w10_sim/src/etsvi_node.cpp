...
int main(int argc, char** argv)
{
    ...
    // Save CSVs into parameterized folder including lyapunov params: src/w10_sim/csv/q<q>_dt<dt>_T<T>_a<alpha>_b<beta>/etsvi/
    ...
    std::string csv_dir = std::string("src/w10_sim/csv/") + params_label + std::string("/etsvi/");
