...
int main(int argc, char** argv)
{
    ...
    // Save into parameterized folder including lyap params: src/w10_sim/csv/q<q>_dt<dt>_T<T>_a<alpha>_b<beta>/ctsvi_ad/
    ...
    std::string csv_dir = std::string("src/w10_sim/csv/") + params_label + std::string("/ctsvi_ad/");
